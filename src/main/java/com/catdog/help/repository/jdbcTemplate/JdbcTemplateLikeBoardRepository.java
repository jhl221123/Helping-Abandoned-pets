...
//
//    @Autowired
//    public JdbcTemplateLikeBoardRepository(DataSource dataSource, JpaBulletinBoardRepository jpaBulletinBoardRepository, UserRepository userRepository) {
...
//            likeBoard.setBoard(jpaBulletinBoardRepository.findById(rs.getLong("board_id")));
