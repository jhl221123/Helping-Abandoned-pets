...
//
//    @Autowired
//    public JdbcTemplateCommentRepository(DataSource dataSource, JpaBulletinBoardRepository jpaBulletinBoardRepository, UserRepository userRepository) {
...
//            comment.setBoard(jpaBulletinBoardRepository.findById(rs.getLong("board_id")));
